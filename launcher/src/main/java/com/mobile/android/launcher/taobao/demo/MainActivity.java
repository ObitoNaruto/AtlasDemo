...
import com.mobile.android.launcher.R;
import com.taobao.android.ActivityGroupDelegate;
import com.mobile.android.launcher.taobao.update.Updater;
...
//                    //跳转第一个bundle中的FirstBundleActivity
//                    switchToActivity("home","com.com.mobile.android.launcher.taobao.firstbundle.FirstBundleActivity");
//                    Toast.makeText(RuntimeVariables.androidApplication,"on click",Toast.LENGTH_SHORT).show();
//                    return true;
//                case R.id.navigation_dashboard://goSecond
//                    //跳转第二个bundle的SecondBundleActivity
//                    switchToActivity("second","com.com.mobile.android.launcher.taobao.secondbundle.SecondBundleActivity");
//                    Toast.makeText(RuntimeVariables.androidApplication, "goSecond onClick", Toast.LENGTH_SHORT).show();
//                    return true;
//                case R.id.navigation_notifications://待定
//                    Intent intent3 = new Intent();
//                    intent3.setClassName(getBaseContext(),"com.com.mobile.android.launcher.taobao.firstBundle.FirstBundleActivity");
//                    mActivityDelegate.execStartChildActivityInternal(mActivityGroupContainer,"third",intent3);
//                    Toast.makeText(MainActivity.this, "待定被点击", Toast.LENGTH_SHORT).show();
//                    return true;
//            }
...
//            Intent intent = new Intent();
//            intent.setClassName(this,"com.com.mobile.android.launcher.taobao.demo.UpdateDemoActivity");
            ...
            intent.setClassName(this,"com.mobile.android.launcher.taobao.demo.RemoteDemoActivity");
            startActivity(intent);
